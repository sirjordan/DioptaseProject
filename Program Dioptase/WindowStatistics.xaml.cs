namespace ProgramDioptase
{
    ...
    public partial class WindowStatistics : Window
    {
        public WindowStatistics()
        {
            ...
            this.MoviesOrderCount.Text = App.Resources.MovieOrdersCount;
            this.GamesOrderCount.Text = App.Resources.GameOrdersCount;
            this.MusicOrderCount.Text = App.Resources.MusicOrdersCount;
        }
